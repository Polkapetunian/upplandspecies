...
const SelectedSpecies = ({ selectedSpecies, selectedRedlistInfo }) => {
  ...
  return (
    ...
    && <div className="car" key={selectedSpecies.swedishName}>
      <h2>
        {selectedSpecies.swedishName.charAt(0).toUpperCase()
          + selectedSpecies.swedishName.slice(1)}
      </h2>
