  ...
  return (
    <div className="card">
      ...
      <p>API står för application programming interface (applikationsprogrammeringsgränssnitt).
        Genom ett API kan man dela med sig av sina data på ett kontrollerat sätt.
        Användarna får inte direkt tillgång till databasen, utan de får ta del av datat på det sätt som API:ets skapare bestämt.
      </p>
